 ...
 * <p>
 * {@link com.badlogic.gdx.scenes.scene2d.utils.ChangeListener.ChangeEvent} is fired when the progress bar knob is moved. Cancelling the event will move the knob to where it was
 * previously.
 * <p>
 ...
 * @author mzechner
 * @author Nathan Sweet */
public class OwnProgressBar extends Widget implements Disableable {
     ...
     * maximum of the height of either the progress bar {@link com.badlogic.gdx.graphics.g2d.NinePatch} or progress bar handle {@link com.badlogic.gdx.graphics.g2d.TextureRegion}. The min and
    ...
    public void draw (Batch batch, float parentAlpha) {
        ...
        if (vertical) {
            ...
            if (knobBefore != null) {
                knobBefore.draw(batch, x + bg.getLeftWidth(), y + (int)((height - knobBefore.getMinHeight()) * 0.5f), (int)(position + knobWidthHalf), knobBefore.getMinHeight());
            }
            if (knobAfter != null) {
                knobAfter.draw(batch, x + (int)(position + knobWidthHalf), y + (int)((height - knobAfter.getMinHeight()) * 0.5f), width - (int)(position + knobWidthHalf) - bg.getRightWidth(), knobAfter.getMinHeight());
            }
    ...
    /** The style for a progress bar, see {@link OwnProgressBar}.
     * @author mzechner
     * @author Nathan Sweet */
