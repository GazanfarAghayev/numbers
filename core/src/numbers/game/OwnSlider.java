 ...
 * <p>
 * {@link com.badlogic.gdx.scenes.scene2d.utils.ChangeListener.ChangeEvent} is fired when the slider knob is moved. Canceling the event will move the knob to where it was previously.
 * <p>
 ...
 * @author mzechner
 * @author Nathan Sweet */
public class OwnSlider extends OwnProgressBar {
     ...
     * the height of either the slider {@link com.badlogic.gdx.graphics.g2d.NinePatch} or slider handle {@link com.badlogic.gdx.graphics.g2d.TextureRegion}. The min and max values determine
    ...
    public OwnSlider  (float min, float max, float stepSize, boolean vertical, SliderStyle style) {
     ...
     * {@link #setVisualInterpolation(com.badlogic.gdx.math.Interpolation) visual interpolation}. */
    public void setVisualInterpolationInverse (Interpolation interpolation) {
        this.visualInterpolationInverse = interpolation;
    }

    /** The style for a slider, see {@link OwnSlider }.
     * @author mzechner
     * @author Nathan Sweet */
